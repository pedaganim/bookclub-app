...
// Mock dependencies
jest.mock('../../../backend/src/lib/local-storage');
jest.mock('../../../backend/src/lib/dynamodb');
jest.mock('../../../backend/src/lib/table-names');
jest.mock('../../../backend/src/lib/aws-config');

const LocalStorage = require('../../../backend/src/lib/local-storage');
const dynamoDb = require('../../../backend/src/lib/dynamodb');
