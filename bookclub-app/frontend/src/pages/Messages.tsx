    ...
    <div className="h-screen flex flex-col bg-gray-50 overflow-hidden">
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 flex-1 flex flex-col min-h-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 flex-1 min-h-0">
          ...
          <div className={`bg-white rounded-lg border border-gray-200 p-4 md:col-span-1 flex flex-col min-h-0 ${routeConversationId ? 'hidden md:flex' : 'flex'}`}>
          ...
          {/* Thread view — full screen on mobile when open */}
          <div className={`bg-white rounded-lg border border-gray-200 p-4 md:col-span-2 flex flex-col min-h-0 ${!routeConversationId ? 'hidden md:flex' : 'flex'}`}>
            {!routeConversationId ? (
              ...
              <>
                <div className="mb-3 shrink-0">
                  ...
                  <button
                    ...
                    className="md:hidden text-sm text-indigo-600 hover:text-indigo-800 mb-2 inline-flex items-center gap-1"
                  >
                    ← Back
                  </button>
